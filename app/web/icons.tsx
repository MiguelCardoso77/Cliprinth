...
export function IconTrash({className}: IconProps) {
    return (
        <StrokeIcon className={className}>
            <path
                d="M4.5 7h15M9.5 7V5a1.5 1.5 0 0 1 1.5-1.5h2A1.5 1.5 0 0 1 14.5 5v2M18 7l-.7 11.5A1.5 1.5 0 0 1 15.8 20H8.2a1.5 1.5 0 0 1-1.5-1.5L6 7"/>
        </StrokeIcon>
    );
}
...
export function IconLink({className}: IconProps) {
    return (
        <StrokeIcon className={className}>
            <path d="M8 12h8"/>
            <path d="M10.5 7.5H7a4.5 4.5 0 0 0 0 9h3.5"/>
            <path d="M13.5 16.5H17a4.5 4.5 0 0 0 0-9h-3.5"/>
        </StrokeIcon>
    );
}
...
export function IconYoutube({className}: IconProps) {
    return (
        ...
        >
            <path
                d="M21.58 7.19a2.7 2.7 0 0 0-1.9-1.92C18.05 4.8 12 4.8 12 4.8s-6.05 0-7.68.47a2.7 2.7 0 0 0-1.9 1.92C2 8.83 2 12 2 12s0 3.17.42 4.81a2.7 2.7 0 0 0 1.9 1.92c1.63.47 7.68.47 7.68.47s6.05 0 7.68-.47a2.7 2.7 0 0 0 1.9-1.92C22 15.17 22 12 22 12s0-3.17-.42-4.81ZM10 15.02V8.98L15.27 12 10 15.02Z"/>
        </svg>
    );
}
...
export function IconStar({className}: IconProps) {
    return (
        <StrokeIcon className={className}>
            <path d="M12 3.5l2.47 5.18 5.53.68-4.1 3.88 1.14 5.56L12 15.9l-4.94 2.9 1.14-5.56-4.1-3.88 5.53-.68L12 3.5Z"
                  strokeLinejoin="round"/>
        </StrokeIcon>
    );
}
